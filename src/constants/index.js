const navLinks = [
  ...
  const counterItems = [
    ...
    { value: 20, suffix: "+", label: "Satisfied Members" },
  ...
  const testimonials = [
    {
      name: "Engr. Kirk Navarro",
      mentions: "kirk.navarro@cit.edu",
      review:
    ...
    {
      name: "Engr. Jacob Abayon",
      mentions: "jacob.abayon@cit.edu",
      review:
    ...
    {
      name: "Engr. Mark Comaingking",
      mentions: "mark.comaingking@cit.edu",
      review:
        "Collaborating with Kurt was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Kurt's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Kurt is the ideal partner.",
      imgPath: "/images/client2.png",
    },
    {
      name: "Engr. Roi Regis",
      mentions: "roi.regis@cit.edu",
      review:
    ...
    {
      name: "Engr. John Lester Pansoy",
      mentions: "johnlester.pansoy@cit.edu",
      review:
        "Kurt was a pleasure to work with. He understood our requirements perfectly and delivered a website that exceeded our expectations. His skills in both frontend dev are top-notch.",
